...
if (
    isset($_POST["nom"], $_POST["email"], $_POST["mdp"], $_POST["tel"], 
          $_POST["ville"], $_POST["daten"], $_POST["role"]) &&
    !empty($_POST["nom"]) &&
    !empty($_POST["email"]) &&
    !empty($_POST["mdp"]) &&
    !empty($_POST["tel"]) &&
    ...
    $user = new User(
        $_GET['id'],               // ID de l'utilisateur à modifier
        $_POST['nom'],
        $_POST['email'],
        $_POST['mdp'],
        $_POST['tel'],
            ...
            <ul class="list-group">
              <li class="list-group-item border-0 d-flex p-4 mb-2 bg-gray-100 border-radius-lg">
                <div class="d-flex flex-column">
                  <h2 class="mb-3 text-sm">Mise a jour  du compte  :  </h6>
                  <?php
                                if (isset($_GET['id'])) {
                                    $olduser = $userC->showUser($_GET['id']);
                                    ?>
                                </div>
    ...
    <li class="list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg">
        <div class="d-flex flex-column">
            <tr>
                ...
                <span class="text-xs">
                    <td><input type="text" id="nom" name="nom" value="<?php echo $olduser['nom']; ?>" /></td>
                </span>
            </tr>
        </div>
    </li>
    ...
    <li class="list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg">
        <div class="d-flex flex-column">
            <tr>
                ...
                <span class="text-xs">
                    <td><input type="text" id="mdp" name="mdp" value="<?php echo $olduser['mdp']; ?>" /></td>
                </span>
            </tr>
        </div>
    </li>
    ...
    <li class="list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg">
        <div class="d-flex flex-column">
            <tr>
                ...
                <span class="text-xs">
                    <td><input type="text" id="email" name="email" value="<?php echo $olduser['email']; ?>" /></td>
                </span>
            </tr>
        </div>
    </li>
    ...
    <li class="list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg">
        <div class="d-flex flex-column">
            <tr>
                ...
                <span class="text-xs">
                    <td><input type="text" id="tel" name="tel" value="<?php echo $olduser['tel']; ?>" /></td>
                </span>
            </tr>
        </div>
    </li>
    ...
    <li class="list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg">
        <div class="d-flex flex-column">
            <tr>
                ...
                <span class="text-xs">
                    <td><input type="text" id="ville" name="ville" value="<?php echo $olduser['ville']; ?>" /></td>
                </span>
            </tr>
        </div>
    </li>
    ...
    <li class="list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg">
        <div class="d-flex flex-column">
            <tr>
                ...
                <span class="text-xs">
                    <td><input type="date" id="daten" name="daten" value="<?php echo $olduser['daten']; ?>" /></td>
                </span>
            </tr>
        </div>
    </li>
        ...
        <div class="d-flex flex-column">
            ...
            <span class="text-xs">
                <select id="role" name="role">
                    <option value="utilisateur normal" <?php if ($olduser['role'] == 'utilisateur normal') echo 'selected'; ?>>utilisateur normal</option>
                    <option value="VIP" <?php if ($olduser['role'] == 'VIP') echo 'selected'; ?>>VIP</option>
                    <option value="admin" <?php if ($olduser['role'] == 'admin') echo 'admin'; ?>>admin</option>
